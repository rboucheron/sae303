<?php
if(isset($_POST['moniteur']) && isset($_POST['plane']) && isset($_POST['reservation']) && isset($_POST['reservationhour']) && isset($_POST['duree'])){
   $reservation = new Reservation; 
   $reservation->Add($_POST['reservation'], $_POST['reservationhour'], $_POST['duree'], $_POST['moniteur'], $_POST['plane']); 
