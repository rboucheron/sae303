	...
	<div id="default-carousel" class="relative" data-carousel="static">
        ...
        <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <img src="file:///Applications/XAMPP/xamppfiles/htdocs/images303/b.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
           
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="file:///Applications/XAMPP/xamppfiles/htdocs/images303/troisAutogires.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
           
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="file:///Applications/XAMPP/xamppfiles/htdocs/images303/course-3.jpg" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
            </div>
        </div>
