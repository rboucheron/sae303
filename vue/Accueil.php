<section class="bg-gradient-to-r from-cyan-200 to-blue-500 w-full relative  p-14 ">
    <div class="w-48 shadow-xl border-gray-500 bg-white rounded-r-xl absolute top-53 left-0" >
        <img class="rounded-r-xl shadow-xl   border-gray-500" src="./assets/images/PipistrelSinus.jpeg" alt="">
    </div>
        ...
        <div class="w-48 shadow-xl	 bg-white rounded-tl-xl absolute bottom-0 right-0" >
        <img class="rounded-tl-xl shadow-xl	" src="./assets/images/b.jpg" alt="">
    </div>
</section>