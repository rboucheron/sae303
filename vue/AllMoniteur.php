...
<section class=" mt-20 w-full">
    <h1 class="text-2xl lg:text-4xl w-3/4 m-auto text-center text-slate-700 font-bold">Notre équipe</h1>
    <h2 class="text-xl lg:text-xl w-3/4 m-auto text-center text-white font-bold">Les personnes qui vont vous accueillir dans notre aéroclub</h2>
    <div class="w-full m-auto mt-10 " id="plane">
        <div class="mt-2 flex flex-wrap justify-center lg:flex-row  relative gap-4 w-full">
            <?php foreach ($resultat as $rowMoniteur) { ?>
                <div class="bg-gray-50  w-80 rounded-lg border-2 border-dashed border-blue-800  relative">
                    <div class="w-full ">
